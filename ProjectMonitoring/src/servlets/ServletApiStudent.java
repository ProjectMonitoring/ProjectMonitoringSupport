...
public class ServletApiStudent extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String conJSON = gson.toJson(allStudents);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String response = req.getParameter("student");
		...
		try
		{
			...
			inserted = dao.insertStudent(newStudent);
		...
		if(inserted)
		{
			writer.write("new student inserted");
		}
		else
		{
			writer.write("error");
	...
	protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		student updateStudent = gson.fromJson(response, student.class);
		...
		try
		{
			...
			updated = dao.updateStudent(updateStudent, updateStudent.getId());
		} catch (SQLException e) {
			e.printStackTrace();
		}
		...
		if(updated)
		{
			writer.write("student: " + updateStudent.getUsername() + " updated");
		}
		else
		{
			writer.write("error");
	...
	protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("student to delete: " + id);
