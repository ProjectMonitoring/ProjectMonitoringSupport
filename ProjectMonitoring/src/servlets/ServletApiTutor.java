...
public class ServletApiTutor extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String conJSON = gson.toJson(allTutors);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String response = req.getParameter("tutor");
		
		tutor newTutor = gson.fromJson(response, tutor.class);
		...
		try
		{
			...
			inserted = dao.insertTutor(newTutor);
		...
		if(inserted)
		{
			writer.write("new tutor inserted");
		}
		else
		{
			writer.write("error");
	...
	protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		tutor updateTutor = gson.fromJson(response, tutor.class);
		...
		try
		{
			...
			updated = dao.updateTutor(updateTutor, updateTutor.getId());
		} catch (SQLException e) {
			e.printStackTrace();
		}
		...
		if(updated)
		{
			writer.write("Tutor: " + updateTutor.getUsername() + " updated");
		}
		else
		{
			writer.write("error");
	...
	protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Tutor to delete: " + id);
		
		boolean deleted = false;
		
		try
		{
			deleted = dao.deleteTutor(id);
		} catch (SQLException e) {
			e.printStackTrace();
		}
