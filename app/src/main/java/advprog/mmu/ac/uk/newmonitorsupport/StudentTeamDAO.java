...
public class StudentTeamDAO {
    ...
    public ArrayList<StudentTeam> getTeamID() {
        ...
        try
        {
            ...
            URL url = new URL("http://10.182.54.37:8005/projMonitoringdb/apiStudentTeam");
    ...
    public ArrayList<Team> getTeam() {
        ...
        {
            // the url we wish to connect to
            URL url = new URL("http://10.182.54.37:8005/projMonitoringdb/apiTeam");
            // open the connection to the specified URL
            urlConnection = (HttpURLConnection) url.openConnection();
            // get the response from the server in an input stream
            in = new BufferedInputStream(urlConnection.getInputStream());
    ...
    public ArrayList<Project> getProject() {
        ...
        {
            // the url we wish to connect to
            URL url = new URL("http://10.182.54.37:8005/projMonitoringdb/apiProject");
            // open the connection to the specified URL
            urlConnection = (HttpURLConnection) url.openConnection();
            // get the response from the server in an input stream
            in = new BufferedInputStream(urlConnection.getInputStream());
